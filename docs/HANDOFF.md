...
Дата: 2026-09-21. Версия кода: `8.4.6`, UI-сборка **b825**, тестов: **328**.
...
git pull && ./scripts/check.sh                      # 328 тестов, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 328 тестов
