...
Дата: 2026-09-23. Версия кода: `8.4.22`, UI-сборка **b840**, тестов: **408**.
...
git pull && ./scripts/check.sh                      # 365 тестов, линт, XSS/CSP-линтер
...
- Версия на сервере: **8.4.5 / b825**, сервис active, счётчики 39/39/4.
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 365 тестов
