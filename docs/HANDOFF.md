...
Дата: 2026-09-21. Версия кода: `8.4.7`, UI-сборка **b826**, тестов: **333**.
...
git pull && ./scripts/check.sh                      # 333 теста, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 333 теста
