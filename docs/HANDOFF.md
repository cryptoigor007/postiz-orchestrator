...
Дата: 2026-09-21. Версия кода: `8.4.16`, UI-сборка **b833**, тестов: **364**.
...
git pull && ./scripts/check.sh                      # 364 теста, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 364 теста
