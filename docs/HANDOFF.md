...
Дата: 2026-09-21. Версия кода: `8.4.8`, UI-сборка **b826**, тестов: **337**.
...
git pull && ./scripts/check.sh                      # 337 тестов, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 337 тестов
