...
Дата: 2026-09-21. Версия кода: `8.4.10`, UI-сборка **b828**, тестов: **346**.
...
git pull && ./scripts/check.sh                      # 346 тестов, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 346 тестов
