...
Дата: 2026-09-21. Версия кода: `8.4.15`, UI-сборка **b832**, тестов: **363**.
...
git pull && ./scripts/check.sh                      # 363 теста, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 363 теста
