...
Дата: 2026-09-21. Версия кода: `8.4.9`, UI-сборка **b827**, тестов: **343**.
...
git pull && ./scripts/check.sh                      # 343 теста, линт, XSS/CSP-линтер
...
# локально (Mac)
cd /Users/dreamstore/Downloads/orchestrator
./scripts/check.sh                 # lint + compile + node + xss/csp + 343 теста
