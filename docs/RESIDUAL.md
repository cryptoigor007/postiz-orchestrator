...
Обновлено: 2026-09-21 · версия **8.4.17 / b834** · тесты **365** · `./scripts/check.sh` PASS
...
| «Сканировать»: невидимый результат (всегда «Найдено: 0») | ✅ 8.4.17 (отчёт: проверено/новых/уже в базе/нет на диске + корни и время) |
