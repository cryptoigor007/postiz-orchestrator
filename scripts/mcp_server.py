...
TOOLS = [
    ...
    ("orch_test_schedule", "Пробный (тестовый) пост в Postiz на тестовый канал",
     {"platform": {"type": "string", "description": "youtube|telegram (allowlist)"},
      "entity_type": {"type": "string", "description": "short|long_video"},
      "entity_id": {"type": "integer"},
      "delay_minutes": {"type": "integer", "description": "по умолчанию 1"},
      "dry_run": {"type": "boolean"}}, "POST", "/webapp/api/test/schedule"),
    ("orch_test_status", "Состояние тестового контура + последние тесты", {},
     "GET", "/webapp/api/test/status"),
    ("orch_test_cancel", "Снять тестовый пост из Postiz",
     {"postiz_post_id": {"type": "string"}}, "POST", "/webapp/api/test/cancel"),
