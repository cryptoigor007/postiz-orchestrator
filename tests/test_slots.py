...
def test_thematic_slots_basic():
    long_dt = datetime(2026, 3, 10, 16, 0, tzinfo=timezone.utc)  # Tue
    next_dt = datetime(2026, 3, 13, 16, 0, tzinfo=timezone.utc)  # Fri
...
def test_thematic_slots_no_next():
    long_dt = datetime(2026, 3, 10, 16, 0, tzinfo=timezone.utc)
...
def test_distribute_with_interval():
    ids = [1, 2, 3, 4]
    base = datetime(2026, 3, 10, 20, 30, tzinfo=timezone.utc)
...
def test_next_long_dates():
    from_dt = datetime(2026, 3, 9, 12, 0, tzinfo=timezone.utc)
